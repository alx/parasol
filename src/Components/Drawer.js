...
import NodeList from "./Networks/NodeList";
      ...
      >
        {drawer.components.map((component, index) => {
          switch (component.name) {
            ...
            case "NetworkInput":
              return (
                <NetworkInput key={drawer.id + index} appState={appState} />
              );
            case "NetworkList":
              return (
                <NetworkList key={drawer.id + index} appState={appState} />
              );
            case "NodeList":
              return <NodeList key={drawer.id + index} appState={appState} />;
            case "NetworkUrlSuffixInput":
              return (
                <NetworkUrlSuffixInput
                  key={drawer.id + index}
                  appState={appState}
                />
              );
            ...
            case "TopicSelector":
              return (
                <TopicSelector key={drawer.id + index} appState={appState} />
              );
            case "SearchInput":
              return (
                <SearchInput key={drawer.id + index} appState={appState} />
              );
            case "EdgeWeight":
            ...
            case "ShowSelected":
              return (
                <ShowSelected key={drawer.id + index} appState={appState} />
              );
            case "SelectedNode":
              return (
                <SelectedNode key={drawer.id + index} appState={appState} />
              );
            case "SelectedNodes":
              return (
                <SelectedNodes key={drawer.id + index} appState={appState} />
              );
            case "NeighborNodes":
              return (
                <NeighborNodes key={drawer.id + index} appState={appState} />
              );
            default:
              break;
          }

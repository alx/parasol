...
export default class NetworkControls extends React.Component {
  constructor(props) {
    ...
    this._openSaveConfigurationDialog = this._openSaveConfigurationDialog.bind(
      this
    );
    this._closeSaveConfigurationDialog = this._closeSaveConfigurationDialog.bind(
      this
    );
        ...
        this.setState({
          networks: this.state.networks.map((network, index) => {
            return Object.assign(network, {
              selected: rowIndexes.indexOf(index) != -1
            });
          })
        });
    }
  ...
  _openAddNetworkDialog() {
    ...
    axios.get(this.props.appState.network_loader.path).then(function(response) {
        ...
        <Dialog
          ...
          actions={
            <FlatButton
              ...
              icon={
                this.state.submittingConfiguration ? (
          ...
          >
            ...
            >
              <TableRow>
                ...
                <TableHeaderColumn tooltip="Loading method">
                  Loader
                </TableHeaderColumn>
              </TableRow>
            </TableHeader>

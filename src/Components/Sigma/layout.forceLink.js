      ...
      (function() {
        (function(undefined) {
          ...
          Supervisor.prototype.applyLayoutChanges = function(prefixed) {
            ...
            // Moving nodes
            for (
              var i = 0, l = this.nodesByteArray.length;
              i < l;
              i += this.ppn
            ) {
              if (!nodes[j].fixed) {
          ...
          Supervisor.prototype.configure = function(config) {
            ...
            switch (config.randomize) {
              case "globally":
                this.randomize = function(x) {
                  return Math.random() * (config.randomizeFactor || 1);
                };
                break;
              case "locally":
                this.randomize = function(x) {
                  return x + Math.random() * (config.randomizeFactor || 1);
                };
                break;
              default:
                this.randomize = function(x) {
          ...
          sigma.layouts.startForceLink = function(sigInst, config) {
            ...
            if (config) supervisor.configure(config);
        ...
        (function(undefined) {
          ...
          var Worker = function(undefined) {
            ...
            function np(i, p) {
              ...
              if (i % W.ppn !== 0)
                throw new Error(
                  'Invalid argument in np: "i" is not correct (' + i + ")."
                );
              if (i !== parseInt(i))
                throw new TypeError(
                  'Invalid argument in np: "i" is not an integer.'
                );
            ...
            function ep(i, p) {
              ...
              if (i % W.ppe !== 0)
                throw new Error(
                  'Invalid argument in ep: "i" is not correct (' + i + ")."
                );
              if (i !== parseInt(i))
                throw new TypeError(
                  'Invalid argument in ep: "i" is not an integer.'
                );
            ...
            function rp(i, p) {
              ...
              if (i % W.ppr !== 0)
                throw new Error(
                  'Invalid argument in rp: "i" is not correct (' + i + ")."
                );
              if (i !== parseInt(i))
                throw new TypeError(
                  'Invalid argument in rp: "i" is not an integer.'
                );
